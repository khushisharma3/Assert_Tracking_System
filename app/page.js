...
export default function Home() {
  ...
  // Immediately change the quantity in products
    ...
    // Immediately change the quantity in dropdown
    ...
    <>
      ...
      <div className='text-green-800 text-center'>{alert}</div>
        <h1 className='text-3xl font-semibold mb-6'>Search a Product</h1>
          ...
          <animate attributeName="stroke-dasharray" repeatCount="indefinite" dur="1.5" values="31.415, 31.415; 0, 62.83; 31.415, 31.415"/>
          </circle>
          </svg>
          </div>
          }
      ...
      <div className='container my-8  mx-auto'>
        ...
        <form>
          ...
          <button onClick={addProduct} type='submit' className='bg-purple-500 hover:bg-purple-60 text-white px-4 py-2 rounded-lg'>Add Product</button>
        </form>
